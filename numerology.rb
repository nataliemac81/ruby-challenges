...
def find_birth_path_number(birthday)
...
def determine_message(birth_path_number)
	...
	when 9
		...
		message = "Sorry. I don't know what your numerology number is."
	end

	puts "Your numerology number is #{birth_path_number}. #{message}"
end


puts "Let's find your birth path number! Tell me your birthday in MMDDYYYY format."

birthday = gets

birth_path_number = find_birth_path_number(birthday)

user_message = determine_message(birth_path_number)
